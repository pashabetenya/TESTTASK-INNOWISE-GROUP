...
mixin _$HomeState on HomeStateBase, Store {
  late final _$pokemonAtom =
      Atom(name: 'HomeStateBase.pokemon', context: context);

  @override
  PokemonPageResponse? get pokemon {
    _$pokemonAtom.reportRead();
    return super.pokemon;
  }

  @override
  set pokemon(PokemonPageResponse? value) {
  ...
  late final _$getPokemonAsyncAction =
      AsyncAction('HomeStateBase.getPokemon', context: context);
